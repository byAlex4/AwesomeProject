...
import { NativeBaseProvider, Box, Text, Pressable, Heading, IconButton, Icon, HStack, Avatar, VStack, Spacer, Center, Button } from 'native-base';
...
function Contacto() {
  ...
  const navigation = useNavigation();
    ...
    return <Center h="290px">
        ...
        <Button title="Go back" onPress={() => navigation.navigate('Draw')} />
